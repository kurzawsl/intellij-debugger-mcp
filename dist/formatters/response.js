 ...
 */
export function formatDebugState(state, sessionId) {
    let content = '';
    if (sessionId) {
 ...
 */
export function formatStackTrace(frames, limit = 10) {
 ...
 */
export function formatVariables(vars, sessionId) {
    let content = '';
    if (sessionId) {
        content += `[Session: ${sessionId}]\n\n`;
    }
 ...
 */
export function formatBreakpoints(response, projectId) {
 ...
 */
export function formatStepResult(result, action) {
